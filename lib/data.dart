...
List<Pet> getPetList(){
  return <Pet>[
    Pet("Viết bài về các loài Mèo", "500.000", "7", "Newest", Category.CAT, "assets/images/cats/cat_1.jpg", true, true),
...
//    Pet("Ragdoll", "Miami", "1.2", "Disappear", Category.CAT, "assets/images/cats/cat_9.jpg", false, true),
    ...
    Pet("Viết bài về các loài Hamster", "600.000", "12", "Newest", Category.HAMSTER, "assets/images/hamsters/hamster_1.jpg", true, true),
...
//    Pet("Dwarf Winter", "Miami", "2.5", "Mating", Category.HAMSTER, "assets/images/hamsters/hamster_7.jpg", true, false),
    ...
    Pet("Viết bài về các loài Thỏ", "600.000", "12", "Newest", Category.BUNNY, "assets/images/bunnies/bunny_1.jpg", true, true),
...
//    Pet("English Spot", "California", "2.5", "Adoption", Category.BUNNY, "assets/images/bunnies/bunny_8.jpg", true, true),
    ...
    Pet("Viết bài về các loài chó", "600.000", "12", "Newest", Category.DOG, "assets/images/dogs/dog_1.jpg", true, true),
